...
class NonCollegeStudent(Student): # Student is the parent class of NonCollegeStudent and imnherits all its attributes
    def __init__(self, first_name, last_name, future_adult_job):
        super().__init__(first_name, last_name)# super() is a function that allows us to call the __init__ method of the parent class Student and pass the arguments only needed for the parent class
